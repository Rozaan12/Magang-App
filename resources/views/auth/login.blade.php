...
<head>
    ...
    <title>Login - Magang Sarastya</title>
                ...
                <div class="row">
                    <div class="col-12 col-sm-8 offset-sm-2 col-md-6 offset-md-3 col-lg-6 offset-lg-3 col-xl-4 offset-xl-4">
                        <div class="login-brand">
                            <img src="{{ asset('assets_admin/img/profile_perusahaan/Logo 4 - Color Horizontal - No Background.png') }}" alt="logo" width="200">
                            <h5 class="mt-3">Magang Sarastya</h5>
                        </div>
